<template>
    <div class="app-container">
        ...
        <div class="search-form">
            <SearchForm :config="searchConfig" @reset="reset" @submit="search"></SearchForm>
        </div>

        <!-- 列表工具 -->
        <div class="toble-tools">
            <div class="left">
                <el-button type="primary" @click="tableBtnFn('create')">上传案例</el-button>
            </div>
            <div class="right">
        ...
        <!-- 列表 -->
        <TableView :columns="columns" :tableData="tableData" :currentChange="handleCurrentChange"
            :sizeChange="handleSizeChange" :pageSize="pageSize" :currentPage="currentPages" :total="total"
            :loading="loading">
            <template #action="{ row }">
