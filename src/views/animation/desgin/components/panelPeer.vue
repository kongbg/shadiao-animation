                ...
                <div class="actions">
                    <el-collapse class="collapse" v-model="sceneAction">
                        <el-collapse-item class="item__warpper" title="动作" name="action">
                            <div class="action" v-for="(act,index) in currentConfInfo.option.actions">
                                <!-- {{ act.id }} -->
                                ...
                                <div  v-for="(item, ai) in act.actions">
                                    ...
                                    <div class="tbaction">
                                        ...
                                        <div :class="['action-wrap', info.id == drawStore.editActionId?'isActive':'']" v-for="(info, index3) in item.actions" @click="editAction(info.id)">
                                            <!-- {{ info.id }} -->
                                            <div class="item" >
                                                ...
                                                />
                                                <el-icon class="add-action" @click="addAction3(item.actions, index3, info)">
                                                    <CirclePlusFilled />
                                                </el-icon>
                                                <el-icon v-show="index3 > 0" @click="removeAction3(index3, item)"><DeleteFilled /></el-icon>
                                            </div>
                                            <component :is="compMap[info.type.join('-')]" :content="currentConfInfo.option.content" :customData="info" :name="schema.name"></component>
                                        </div>
                                ...
                                <el-button type="primary" size="small" @click="addAction2(act)">新增同步动作</el-button>
                            </div>
                            <el-button class="add-btn" type="primary" size="small" @click="addAction">新增异步动作</el-button>
                        </el-collapse-item>
                    </el-collapse>
                </div>
            </el-tab-pane>
