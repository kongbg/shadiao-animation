...
// })`;
let ids = [generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID(),generateUniqueID()]
...
function create(data) {
    ...
    // let dx = Math.floor(Math.random() * 40) + 1;
    // obj.x = (960/2)+dx;
    // obj.y = (540/2)+dx;
