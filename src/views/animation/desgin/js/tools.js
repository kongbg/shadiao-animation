...
export function createComp(data) {
  ...
  let throttleFn = throttle(function (event) {
    ...
    if (
      !(targetElement.closest('#game') || targetElement.closest('.pannelPeer'))
    ) {
...
function onDragStart(event) {
  ...
  this.initialScale = new PIXI.Point(this.scale.x, this.scale.y)
  // 点击处坐标跟锚点的差值
  this.diff = {
...
function onDragMove(event) {
  if (this.dragging) {
    ...
    if (this.data.originalEvent.shiftKey) {
      ...
      if (this.y > this.screen.height - this.pivot.y)
