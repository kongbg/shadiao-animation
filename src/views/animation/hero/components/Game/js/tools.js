...
export function getImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/${name}.${ext}`, import.meta.url).href
}

export function getStageImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/stage/${name}.${ext}`, import.meta.url).href
}

export function getEnemyImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/enemy/${name}.${ext}`, import.meta.url).href
}

export function getHeroImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/hero/${name}.${ext}`, import.meta.url).href
}

export function getNpcImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/npc/${name}.${ext}`, import.meta.url).href
}

export function getOtherImageUrl(name, ext = "png") {
    return new URL(`/src/assets2/other/${name}.${ext}`, import.meta.url).href
}

export function getAudioUrl(name, ext = "mp3") {
    return new URL(`/src/assets2/audio/${name}.${ext}`, import.meta.url).href
}
